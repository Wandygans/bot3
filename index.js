...
nocache('./lib/photooxy.js', module => console.log(color('|TRM|'), color(`Photooxy Updated!`, 'cyan')))
...
pemuda.on('CB:action,,call', async json => {
        ...
        pemuda.sendMessage(callerId, { displayname: `${NamaOwner}`, vcard: vcard}, MessageType.contact, {contextInfo: { externalAdReply:{title: `Developer ${NamaBot}`,body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:`https://wa.me/6281290565513?text=Assalamualaikum`}}})
        await sleep(5000)
